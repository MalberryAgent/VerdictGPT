...
checkpoints_dir = "/workspace/nanochat_checkpoints/sft_bigbatch_best"
model, tokenizer, meta_data = load_model_from_dir(checkpoints_dir, device, phase="eval", model_tag="d12", step=24000)
