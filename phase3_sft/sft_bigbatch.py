...
BEST_DIR = "/workspace/nanochat_checkpoints/sft_bigbatch_best/d12"
...
optimizer = model.setup_optimizer(matrix_lr=0.0056, embedding_lr=0.056, unembedding_lr=0.0011, scalar_lr=0.14)
